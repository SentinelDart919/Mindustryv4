...
public class Minimap extends Table{
    ...
    public Minimap(){
        super((Drawable)Core.atlas.getDrawable("pane"));
        ...
        Element elem = new Element(){
            ...
            public void draw(){
                ...
                Draw.rect(renderer.minimap.getRegion(), x, y, width, height);
                ...
                if(showFog){
                    ...
                    float px = r.u * world.width() + pad;
                    float py = r.v * world.height() + pad;
                    float px2 = r.u2 * world.width() + pad;
                    float py2 = r.v2 * world.height() + pad;

                    r.texture = renderer.fog.getTexture();
