...
public class Bits{
    ...
    public static short getLeftShort(int value) {
        return (short) ((value >>> 16) & 0xFFFF);
    }

    public static short getRightShort(int value) {
    ...
    public static int packInt(byte[] values) {
    ...
    public static short getLeftInt(int value) {
        return (short)((value >>> 16) & 0xFFFF);
    }

    public static short getRightInt(int value) {
        return (short)(value & 0xFFFF);
    }
    ...
    public static long packLong(short[] values) {
        return ((long)(values[0] & 0xFFFF) << 48) |
               ((long)(values[1] & 0xFFFF) << 32) |
               ((long)(values[2] & 0xFFFF) << 16) |
               (values[3] & 0xFFFFL);
    }

    public static short[] getShorts(long value, short[] out) {
        out[0] = (short)((value >>> 48) & 0xFFFF);
        out[1] = (short)((value >>> 32) & 0xFFFF);
        out[2] = (short)((value >>> 16) & 0xFFFF);
        out[3] = (short)(value & 0xFFFF);
        return out;
    }

    public static byte[] getBytes(int value, byte[] out) {
    ...
    public static int toByte(boolean value){
        return value ? 1 : 0;
    }
