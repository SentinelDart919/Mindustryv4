...
public class Table extends WidgetGroup{
    ...
    private Drawable d(String name){
        if(scene.hasStyle(Skin.class)){
            return scene.getStyle(Skin.class).get(name, Drawable.class);
        }
    ...
    public Cell<Table> table(String background, Cons<Table> cons){
        return table(d(background), cons);
    }
    ...
    public Cell<Image> image(String drawableName){
        return image(Core.scene.getSkin().getDrawable(drawableName));
    }
    ...
    public Cell<ImageButton> addImageButton(String icon, String style, float isize, Runnable listener){
        return add(Elem.newImageButton(scene.getStyle(Skin.class).get(style, ImageButtonStyle.class), d(icon), isize, listener));
    }

    public Cell<TextField> addField(String text, Cons<String> listener){
        return field(text, listener);
    }
