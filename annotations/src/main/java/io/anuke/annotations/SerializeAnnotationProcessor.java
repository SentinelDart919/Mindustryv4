    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv){
        ...
        try{
            ...
            for(TypeElement elem : elements){
                ...
                ClassName.bestGuess("arc.util.io.TypeSerializer"), type));
                ...
                for(VariableElement field : fields){
                    ...
                    if(field.asType().getKind().isPrimitive()){
                        ...
                        writeMethod.addStatement("arc.Settings.getSerializer(" + typeName+ ".class).write(stream, object." + name + ")");
                        readMethod.addStatement("object." + name + " = (" +typeName+")arc.Settings.getSerializer(" + typeName+ ".class).read(stream)");
                    }
                }
                ...
                method.addStatement("arc.Settings.setSerializer($N, $L)",  Utils.elementUtils.getBinaryName(elem).toString().replace('$', '.') + ".class", serializer.build());
            }
